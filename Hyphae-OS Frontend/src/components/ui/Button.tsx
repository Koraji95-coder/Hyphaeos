...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-hyphae-500 hover:bg-hyphae-600 focus:ring-hyphae-500 text-white',
    secondary: 'bg-spore-500 hover:bg-spore-600 focus:ring-spore-500 text-dark-300',
    ghost: 'bg-transparent hover:bg-hyphae-500/10 border border-hyphae-500/30 text-hyphae-300',
  };
