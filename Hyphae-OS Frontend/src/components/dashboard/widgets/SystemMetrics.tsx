      ...
      <div className="p-4">
        ...
        <div className="bg-dark-300/70 rounded-lg p-4 relative h-48">
          <div className="absolute top-4 left-4 right-4">
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-sm font-medium text-white">System Performance (24h)</h3>
          ...
          <div className="h-full pt-8">
            <svg width="100%" height="calc(100% - 8px)" viewBox="0 0 100 100" preserveAspectRatio="none">
              {/* Grid lines */}
              ...
              <line x1="100" y1="0" x2="100" y2="100" stroke="rgba(255,255,255,0.1)" strokeWidth="0.5" />
