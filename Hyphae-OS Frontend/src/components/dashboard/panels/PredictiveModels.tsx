    ...
    <div className="p-6 lg:p-8 min-h-screen">
      ...
      >
        ...
        >
          ...
          <p className="text-2xl font-bold text-white">{modelsData.filter(m => m.status === 'active').length}</p>
                ...
                >
                  <div className="flex items-center">
                    <div className={`w-2 h-2 rounded-full mr-3 ${
                      index === 0 ? 'bg-success-500 animate-pulse' : 'bg-gray-500'
                    }`}></div>
                    <div>
                      <p className="text-sm font-medium text-white">{model.name}</p>
                      <p className="text-xs text-gray-400">Agent: {model.agent}</p>
                    </div>
                  </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Model retraining is scheduled based on performance metrics and data drift detection.
                  </p>
                </div>
              </div>
            </div>
